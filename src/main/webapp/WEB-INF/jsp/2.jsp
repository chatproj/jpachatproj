				...
				<div id="yourMsg" class="yourMsg">
					<table class="inputTable">
						<tr>
							...
							<th><input id="uploadbtn" class="uploadbtn" type="file" name="uploadfile" accept="*" /></th>
							<th><button type="button" id="sendBtn" class="sendBtn" onclick="uploadFile();">업로드</button></th>
							</form>
						</tr>
						<tr>
...
<script type="text/javascript">
	...
	function uploadFile() {
		var cnumPK = "<%=cnumPK %>";
		var uploadfile1 = new FormData($("#upload-file-form")[0]);

		AjaxUploadFile(uploadfile1);
	}
	
	function AjaxUploadInform(cnumPK){
 		$.ajax({
			type: 'POST',
			url: "/uploadFile",
			data: {
	...
	function AjaxUploadFile(uploadfile1){
		$.ajax({
		    url: "/uploadFile",
		    type: "POST",
		    data: uploadfile1,
